...
InSpec profile to validate the secure configuration of MongoDB Enterprised Advanced, against [DISA](https://iase.disa.mil/stigs/)'s **MongoDB Enterprise Advanced Security Technical Implementation Guide (STIG) Version 2, Release 14**.
